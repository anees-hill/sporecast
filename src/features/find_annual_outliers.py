...
# All variables that work with this dataset
...
# DOES NOT NEED TO BE RUN EACH TIME. SEE END OF CHUNK TO LOAD SAVED OUTLIER LIST
...
# Run extract_annual_ts() on all tuples within crossing1
# Use crossing1 as an index
...
# Export
with open(base_dir/"data"/"interim"/"annual_outliers.pkl", "wb") as f:
